...
Change [first line of `saved_networks/checkpoint`](https://github.com/Yaoshicn/DeepLearningFlappyFrog/blob/master/saved_networks/checkpoint#L1) to 

`model_checkpoint_path: "saved_networks/frog-dqn-3050000"`

#### How to reproduce?
1. Comment out [these lines](https://github.com/Yaoshicn/DeepLearningFlappyFrog/blob/master/deep_q_network.py#L115-L119)
...
3. [yenchenlin1994/DeepLearningFlappyBird](https://github.com/yenchenlin1994/DeepLearningFlappyBird)
